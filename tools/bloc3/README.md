...
La validation vérifie les sources, la correspondance des critères, les données des trois graphiques natifs, les notes, les formules, les liens, les rendus et le contenu du ZIP. Elle ne rejoue pas les tests applicatifs et ne décide pas de l’acquisition des compétences.
