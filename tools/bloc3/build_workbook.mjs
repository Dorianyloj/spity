...
const out=path.join(root,'output/bloc-03/pilotage-spity.xlsx');await fs.mkdir(path.dirname(out),{recursive:true});await(await SpreadsheetFile.exportXlsx(wb)).save(out);
