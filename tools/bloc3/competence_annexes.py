...
La méthode retenue pour le cas est Kanban : petit effectif, priorités évolutives, retours rapides et limite de deux travaux de réalisation simultanés. Scrum introduirait des cérémonies supplémentaires pour ce lot ; un cycle en V rendrait les retours intermédiaires moins fréquents. Les critères de recette conditionnent le passage à Terminé.
