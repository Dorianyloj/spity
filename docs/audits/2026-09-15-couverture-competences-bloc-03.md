...
| P | [PowerPoint v8](../../output/presentations/spity-bloc-3-30-minutes-visuel-v8.pptx) | Textes des diapositives, notes et catégories des graphiques du fichier livré. Relecture visuelle ciblée des slides 5, 15, 17 et 18, avec les rendus de la même version. |
| D | [Dossier source](../rncp/bloc-03/DOSSIER_BLOC_03.md) et [PDF](../../output/pdf/dossier-bloc-03-spity.pdf) | Sept compétences, annexes A01 à A09 et portée des preuves techniques. Les pages citées ci-dessous sont celles du PDF de 27 pages. |
| X | [Classeur de pilotage](../../outputs/bloc03-01a09eba/pilotage-spity.xlsx) | Présence des indicateurs, charges, dates initiales/revues et risques dans le fichier exporté. Lecture des valeurs enregistrées, sans nouvelle exécution de calcul dans Excel. |
