...
Vérifier /api/health, les deux connexions, les pages /app/matching et /app/events, puis un parcours complet. Noter la version et le SHA. Préparer le diaporama v20, le classeur et les preuves hors connexion. Désactiver les notifications personnelles et fermer les onglets sans rapport avec le projet.
