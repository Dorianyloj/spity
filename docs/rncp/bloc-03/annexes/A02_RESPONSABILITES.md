...
| QA | 30 h sur le même horizon ; critères, recette et accessibilité. |
...
Le cadre prévoit la consultation préalable des besoins d'aménagement, des supports structurés, une navigation clavier et des synthèses écrites. Les décisions sont accessibles de façon asynchrone ; les horaires indiquent le fuseau. Une adaptation est convenue avec la personne concernée, sans diagnostic ni donnée médicale dans les comptes rendus.
