# Matrice — sept compétences du Bloc 3

Les sources du candidat imposent trois compétences obligatoires, et le support traite les sept. La couverture ci-dessous est documentaire ; elle ne constitue pas une décision du jury. Les exemples simulés sont signalés dans les diapositives et les annexes.
...
Le détail critère par critère figure dans [CONTROLE_COMPLETUDE.md](CONTROLE_COMPLETUDE.md). Les simulations ne remplacent ni l’exécution du logiciel ni la capacité du candidat à expliquer les choix.
