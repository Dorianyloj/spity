...
### 7. Les causes des cinq heures supplémentaires
...
Tu annonces le passage à l'application locale avec des comptes de test : d'abord le grimpeur, puis le club. Cette transition fait partie des six minutes de démonstration prévues avec les slides 20 et 21.
...
### 24. Annexe : sensibilité du budget et de la capacité
...
Les slides 23 à 25 servent aux questions du jury. Elles ne s'ajoutent pas aux trente minutes prévues pour les slides 1 à 22.
