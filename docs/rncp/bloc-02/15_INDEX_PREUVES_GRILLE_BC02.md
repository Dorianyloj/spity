...
| Le protocole définit les différentes séquences de déploiement. | Conditions d'entrée, sauvegarde, migration one-shot, démarrage, contrôle, promotion et rollback sont ordonnés. | [Manuel de déploiement](12_MANUEL_DEPLOIEMENT_C241.md), [runbook de release](../../../spity/docs/operations/DEPLOYMENT.md) | Couvert |
