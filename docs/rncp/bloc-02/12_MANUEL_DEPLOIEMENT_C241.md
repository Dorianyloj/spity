...
| Sources exécutables | [`spity/docker-compose.yml`](../../../spity/docker-compose.yml), [`spity/docker-compose.production.yml`](../../../spity/docker-compose.production.yml), [`spity/docs/operations/DEPLOYMENT.md`](../../../spity/docs/operations/DEPLOYMENT.md) |
...
La configuration d'environnement et les contrôles qualité sont décrits dans [C2.1.1](02_ENVIRONNEMENTS_QUALITE_DEPLOIEMENT.md). La chaîne distante, les images immuables et la release `v0.1.0` sont tracées dans [C2.2.4](09_VERSIONS_DEPLOIEMENTS_C224.md). La procédure courte réellement embarquée avec la release est [`spity/docs/operations/DEPLOYMENT.md`](../../../spity/docs/operations/DEPLOYMENT.md).
