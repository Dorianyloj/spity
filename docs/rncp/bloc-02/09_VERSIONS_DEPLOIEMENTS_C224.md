...
La version `0.1.0` couvre les parcours inscription, connexion, profil, lieux, matching, partenariats et événements. Le prototype peut être démarré localement avec Docker ou depuis ses images de release en suivant [`spity/docs/operations/DEPLOYMENT.md`](../../../spity/docs/operations/DEPLOYMENT.md).
