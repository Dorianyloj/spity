...
> Archive de cadrage. Le dossier final et les preuves à jour se trouvent dans ce même répertoire `docs/rncp/bloc-02/`. Les mentions « à produire » ci-dessous décrivent l'état initial du 20 juillet 2026 et ne constituent plus le suivi courant.
...
|---|---|---|---|---|
| P01 | C2.1.1 | Description des environnements | `docs/rncp/bloc-02/02_ENVIRONNEMENTS_QUALITE_DEPLOIEMENT.md` | Présent |
| P02 | C2.1.1 | Protocole de déploiement continu | `docs/rncp/bloc-02/02_ENVIRONNEMENTS_QUALITE_DEPLOIEMENT.md` | Présent |
| P03 | C2.1.1 | Critères qualité et performance | `docs/rncp/bloc-02/02_ENVIRONNEMENTS_QUALITE_DEPLOIEMENT.md` | Présent |
| P04 | C2.1.2 | Workflow d'intégration continue | `.github/workflows/ci.yml` | Présent |
| P05 | C2.1.2 | Protocole d'intégration | `docs/rncp/bloc-02/03_PROTOCOLE_INTEGRATION_CONTINUE.md` | Présent |
| P06 | C2.2.1 | Architecture structurée | `docs/rncp/bloc-02/05_ARCHITECTURE_PROTOTYPE_C221.md` | Présent |
...
| P08 | C2.2.2 | Jeu de tests et couverture | `docs/rncp/bloc-02/04_HARNAIS_TESTS_UNITAIRES.md`, `06_TESTS_INTEGRATION_C222.md` et run CI 29740751753 | Présent |
