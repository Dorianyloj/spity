...
| Livrables présents dans `docs/rncp/bloc-02/` | 16/16 |
...
Le PDF contient la synthèse rédigée à la première personne, un chapitre renforcé sur les quatre compétences déterminantes, mon retour d'expérience technique, l'index des vingt-six critères et neuf annexes visuelles. Les documents techniques détaillés restent accessibles par les liens GitHub et dans `docs/rncp/bloc-02/`. Pour une remise sans accès réseau, il faut transmettre le PDF avec ce dossier ou une archive du dépôt.
