...
| [PowerPoint Bloc 3 visuel](presentations/spity-bloc-3-30-minutes-visuel-v15.pptx) | `tools/bloc3/build_deck_presentable.py` | 23 slides principales, sommaire compris, 7 graphiques modifiables, grille de compétences, suivi client, captures datées et démo de 6 minutes, puis 3 annexes. |
| [PDF du diaporama Bloc 3](pdf/spity-bloc-3-30-minutes-visuel-v15.pdf) | PowerPoint v15 | Version à consulter ou projeter sans PowerPoint. |
