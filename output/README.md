...
| [PowerPoint Bloc 3 visuel](bloc-03/spity-bloc-3-30-minutes-visuel-v17.pptx) | `tools/bloc3/build_deck_presentable.py` | 23 slides principales, sommaire compris, 3 graphiques modifiables, sept compétences dans l’ordre, projet solo sur un an, exemples simulés annoncés et démo de 6 minutes, puis 3 annexes. |
| [PDF du diaporama Bloc 3](bloc-03/spity-bloc-3-30-minutes-visuel-v17.pdf) | PowerPoint v17 | Version à consulter ou projeter sans PowerPoint. |
...
La présentation courante est la **v17**. Les versions précédentes sont conservées dans [`bloc-03/archives/`](bloc-03/archives/) ; elles ne sont pas les fichiers à utiliser pour la soutenance. Tous les nouveaux exports vont dans le dossier du bloc concerné.
