...
const files = [...new Set([
  ...
  resolve(repositoryRoot, 'docs/rncp/bloc-04/dossier/README.md'),
  resolve(repositoryRoot, 'docs/rncp/bloc-04/dossier/01_CADRAGE_PROJET.md'),
  resolve(repositoryRoot, 'docs/rncp/bloc-04/dossier/02_C4_1_MAINTENANCE_ET_SUPERVISION.md'),
  resolve(repositoryRoot, 'docs/rncp/bloc-04/dossier/03_C4_2_ANOMALIES_ET_CORRECTIFS.md'),
  resolve(repositoryRoot, 'docs/rncp/bloc-04/dossier/04_C4_3_EVOLUTION_RELEASE_SUPPORT.md'),
  resolve(repositoryRoot, 'docs/rncp/bloc-04/dossier/05_PREUVES_REPRODUCTIBILITE_ET_ENTRETIEN.md'),
  resolve(repositoryRoot, 'docs/rncp/bloc-04/dossier/annexes/GLOSSAIRE.md'),
  resolve(repositoryRoot, 'docs/rncp/bloc-04/dossier/annexes/MATRICE_DE_PREUVES.md'),
  ...
  resolve(repositoryRoot, 'livrables/README.md'),
  resolve(repositoryRoot, 'livrables/bloc-04/README.md'),
