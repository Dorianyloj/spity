...
const files = [
  ...
  resolve(repositoryRoot, 'spity/docs/operations/MAINTENANCE.md'),
  resolve(repositoryRoot, 'spity/docs/operations/INCIDENT_MANAGEMENT.md'),
  resolve(repositoryRoot, 'spity/docs/operations/IMPROVEMENT_MANAGEMENT.md'),
  resolve(repositoryRoot, 'spity/docs/operations/RELEASE_JOURNAL.md'),
  resolve(repositoryRoot, 'spity/docs/operations/RELEASE_VERIFICATION.md'),
  resolve(repositoryRoot, 'spity/docs/operations/OBSERVABILITY.md'),
  resolve(repositoryRoot, 'spity/docs/operations/SUPPORT.md'),
  ...
  resolve(repositoryRoot, 'output/bloc-04/dossier-bloc-04-spity.pdf'),
