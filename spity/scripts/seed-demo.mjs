    ...
    await insert(connection, 'salles', [
      {
        ...
        services: toJson(['vestiaires', 'douches', 'location_materiel', 'restauration', 'entrainement', 'parking_velo']),
        ...
        restrictions: 'Magnésie liquide recommandée dans les espaces de bloc.',
        source_url: 'https://www.openstreetmap.org/?mlat=45.7331&mlon=4.8307#map=17/45.7331/4.8307',
        notes: 'Salle de bloc avec restauration et espace entraînement. Affluence généralement plus forte en soirée.',
      },
      {
        id: ids.salles.mroc,
        ...
        services: toJson(['vestiaires', 'douches', 'location_materiel', 'entrainement', 'parking_velo']),
        ...
        restrictions: 'Vérifier les créneaux réservés aux cours avant la séance.',
        source_url: 'https://www.openstreetmap.org/?mlat=45.7624&mlon=4.8843#map=17/45.7624/4.8843',
        notes: 'Salle mixte bloc et voie, adaptée aux séances autonomes comme aux entraînements encadrés.',
      },
    ])
    ...
    await insert(connection, 'falaises', [
      {
        ...
        disciplines: toJson(['voie']),
        rock_type: 'calcaire',
        rain_exposure: 'expose',
        sunlight: 'ensoleille',
        ...
        longitude: 4.8218,
        orientation: 'sud',
        orientations: toJson(['sud_est', 'sud', 'sud_ouest']),
        approche: '12 min depuis le parking du village',
        parking: 'Parking de Curis, 18 places',
        parking_latitude: 45.872067,
        parking_longitude: 4.822955,
        saison: toJson(['printemps', 'automne']),
        status: 'sec',
        restrictions: 'Éviter le site pendant 48 h après de fortes pluies et respecter les zones temporairement balisées.',
        source_url: 'https://www.openstreetmap.org/?mlat=45.8733&mlon=4.8218#map=17/45.8733/4.8218',
        notes: 'Site de proximité principalement orienté au sud. Casque recommandé au pied des voies.',
      },
      {
        id: ids.falaises.cormot,
        nom: 'Falaise de Cormot',
        location: 'Cormot-Vauchignon',
        department: 'Côte-d’Or',
        region: 'Bourgogne-Franche-Comté',
        acces: 'Secteurs variés, casque recommandé au pied des voies.',
        disciplines: toJson(['voie', 'grande_voie', 'trad']),
        rock_type: 'calcaire',
        rain_exposure: 'partiellement_abrite',
        sunlight: 'mixte',
        ...
        longitude: 4.6328,
        orientation: 'multi',
        orientations: toJson(['est', 'sud_est', 'sud', 'ouest']),
        approche: '20 à 35 min selon secteur',
        parking: 'Parking principal avant le sentier balisé',
        parking_latitude: 46.9701,
        parking_longitude: 4.6352,
        saison: toJson(['printemps', 'ete', 'automne']),
        status: 'attention',
        restrictions: 'Rester sur les sentiers d’accès et vérifier les éventuelles restrictions locales avant le départ.',
        source_url: 'https://www.openstreetmap.org/?mlat=46.9684&mlon=4.6328#map=16/46.9684/4.6328',
        notes: 'Plusieurs secteurs et orientations permettent d’adapter la sortie aux conditions du jour.',
      },
    ])
