...
> **Accès jury :** [`../JURY.md`](../JURY.md) donne le parcours de lecture, tandis que [`../livrables/`](../livrables/) contient uniquement les fichiers finaux à remettre.
...
- [Dossier source Bloc 4](../docs/rncp/bloc-04/dossier/README.md)
- [Livrable final Bloc 4](../livrables/bloc-04/README.md)
