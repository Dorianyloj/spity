...
\begin{frame}
  ...
  \vspace{-0.5cm}
  \begin{center}
    \includegraphics[height=1.2cm]{../../public/images/brand/logo-spity.png}
  \end{center}
\end{frame}
...
\begin{frame}{Spity en une phrase}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \includegraphics[width=\textwidth,height=0.55\textheight,keepaspectratio]{../../public/images/brand/escalade-falaise.jpeg}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{block}{Vision}
...
\begin{frame}
  \begin{center}
    ...
    \includegraphics[height=1.4cm]{../../public/images/brand/logo-spity.png}
  \end{center}
\end{frame}
