...
> Dans le dépôt, exécuter les commandes depuis `spity/`. Les chemins de configuration sont relatifs à ce dossier ; pour un bundle de release, suivre les indications du guide.
...
Cette procédure autonome est incluse dans chaque bundle de release. Elle déploie les images immuables de l'application et des migrations avec MariaDB. Le manuel détaillé et les choix techniques sont documentés dans [`../../../docs/rncp/bloc-02/12_MANUEL_DEPLOIEMENT_C241.md`](../../../docs/rncp/bloc-02/12_MANUEL_DEPLOIEMENT_C241.md) lorsque le dépôt complet est disponible.
