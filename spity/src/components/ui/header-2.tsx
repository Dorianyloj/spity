...
export function Header({ links = publicLinks, homeHref = '/', accountLabel, actions, mobileActions, overlay = false }: {
  ...
  return <header data-spity-header data-scrolled={scrolled} className={cn('top-0 z-40 px-3 pt-[max(0.75rem,env(safe-area-inset-top))] sm:px-6', overlay ? 'fixed inset-x-0' : 'sticky')}>
